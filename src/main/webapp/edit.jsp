...
<head>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById("form-author").value = '<%=post.getAuthor()%>';
            document.getElementById("form-email").value = '<%=post.getEmail()%>';
            document.getElementById("form-title").value = '<%=post.getTitle()%>';
            document.getElementById("form-category").value = '<%=post.getCategory()%>';
            document.getElementById("form-likes").value = '<%=post.getLikes()%>';
            document.getElementById("form-public").checked = <%=post.isPubl()%>;
            document.getElementById("form-color<%=Integer.toString(a)%>").checked = true;
        ...
        function beforeSubmit(){
            ...
            if(valid[0]&&valid[1]&&valid[2]&&valid[3]&&valid[5]&&valid[6]){
                console.log(valid)
...
<div class="row justify-content-center p-3">
    ...
    <div class="col col-12 col-md-6">
        <form method="post" id="form" action="edit_ok.jsp" enctype="multipart/form-data">
            <div>
            ...
            <div>
                <textarea id="form-content" class="form-text form-control" placeholder="내용" name="content" required onfocusout="upDate(this)"><%=post.getContent()%></textarea>
                <p id="form-content-invalid" class="form-invalid">내용을 작성해야 합니다</p>
            </div>
            <div class="d-block">
                <input id="form-file" type="file" class="form-control form-text" title="dlsdkjflsdkfj" accept="image/*" name="photo">
            ...
            <div class="form-check form-switch">
                <input class="form-check-input" type="checkbox" role="switch" name="public" id="form-public">
                <label class="form-check-label" for="form-public">공개설정</label>
            </div>
            <div class="justify-content-end d-flex">
                <button type="reset" class="btn btn-secondary ms-210" onclick="window.history.back()">취소</button>
